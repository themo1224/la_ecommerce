        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide position-relative h-100 w-100">
                ...
                <div
                    ...
                    <p class="title-small text-white opacity-75 mb-0" data-swiper-parallax="-100">همه چیزی که نیاز دارید</p>
                    <h2 class="display-3 tracking-wide fw-bold text-uppercase tracking-wide text-white" data-swiper-parallax="100">
                        <span class="text-outline-light">تابستان</span> ضروریات</h2>
                    <div data-swiper-parallax-y="-25">
                        <a href="./category.html" class="btn btn-psuedo text-white" role="button">خرید آیتم‌های جدید</a>
                    </div>
                </div>
            </div>
            <!-- /Slide-->
            ...
            <div class="swiper-slide position-relative h-100 w-100">
                ...
                <div
                    class="container position-relative z-index-10 d-flex h-100 align-items-start flex-column justify-content-center">
                    <p class="title-small text-white opacity-75 mb-0" data-swiper-parallax="-100">مجموعه بهار</p>
                    <h2 class="display-3 tracking-wide fw-bold text-uppercase tracking-wide text-white" data-swiper-parallax="100">
                        آدیداس <span class="text-outline-light">فصل بهار 21</span></h2>
                    <div data-swiper-parallax-y="-25">
                        <a href="./category.html" class="btn btn-psuedo text-white" role="button">خرید آخرین آدیداس</a>
                    </div>
                </div>
            </div>
            <!--/Slide-->
            ...
            <div class="swiper-slide position-relative h-100 w-100">
                ...
                <div
                    class="container position-relative z-index-10 d-flex h-100 align-items-start flex-column justify-content-center">
                    <p class="title-small text-white opacity-75 mb-0" data-swiper-parallax="-100">فقط انجام بدهید</p>
                    <h2 class="display-3 tracking-wide fw-bold text-uppercase tracking-wide text-white" data-swiper-parallax="100">
                        نایک <span class="text-outline-light">فصل بهار 21</span></h2>
                    <div data-swiper-parallax-y="-25">
                        <a href="./category.html" class="btn btn-psuedo text-white" role="button">خرید آخرین نایک</a>
                    </div>
                </div>
            </div>
            <!-- /Slide-->
            ...
            <div class="swiper-slide position-relative h-100 w-100">
                ...
                <div
                    class="container position-relative z-index-10 d-flex h-100 align-items-start flex-column justify-content-center">
                    <p class="title-small text-white opacity-75 mb-0" data-swiper-parallax="-100">خوب دیده می‌شوید، خوب احساس می‌کنید</p>
                    <h2 class="display-3 tracking-wide fw-bold text-uppercase tracking-wide text-white" data-swiper-parallax="100">
                        <span class="text-outline-light">مد پایدار</span> فشن</h2>
                    <div data-swiper-parallax-y="-25">
                        <a href="./category.html" class="btn btn-psuedo text-white" role="button">چرا ما متفاوتیم</a>
                    </div>
                </div>
            </div>
            <!--/Slide-->
